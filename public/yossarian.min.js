...
}}}}),ge=Ha({terminal:!0,priority:1e3}),he=["$locale","$interpolate",function(a,c){var d=/{}/g;return{restrict:"EA",link:function(e,f,g){var k=g.count,h=g.$attr.when&&f.attr(g.$attr.when),l=g.offset||0,m=e.$eval(h)||{},q={},p=c.startSymbol(),n=c.endSymbol(),s=/^when(Minus)?(.+)$/;r(g,function(a,c){s.test(c)&&(m[N(c.replace("when","").replace("Minus","-"))]=f.attr(g.$attr[c]))}),r(m,function(a,e){q[e]=c(a.replace(d,p+k+"-"+l+n))}),e.$watch(function(){var c=parseFloat(e.$eval(k));return isNaN(c)?"":(c in m||(c=a.pluralCat(c-l)),q[c](e))},function(a){f.text(a)})}}}],ie=["$parse","$animate",function(a,c){var d=y("ngRepeat"),e=function(a,c,d,e,l,m,q){a[d]=e,l&&(a[l]=m),a.$index=c,a.$first=0===c,a.$last=c===q-1,a.$middle=!(a.$first||a.$last),a.$odd=!(a.$even=0===(1&c))};return{restrict:"A",multiElement:!0,transclude:"element",priority:1e3,terminal:!0,$$tlb:!0,compile:function(f,g){var k=g.ngRepeat,h=X.createComment(" end ngRepeat: "+k+" "),l=k.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+track\s+by\s+([\s\S]+?))?\s*$/);if(!l)throw d("iexp",k);var m=l[1],q=l[2],p=l[3],n=l[4],l=m.match(/^(?:([\$\w]+)|\(([\$\w]+)\s*,\s*([\$\w]+)\))$/);if(!l)throw d("iidexp",m);var s=l[3]||l[1],J=l[2];if(p&&(!/^[$a-zA-Z_][$a-zA-Z0-9_]*$/.test(p)||/^(null|undefined|this|\$index|\$first|\$middle|\$last|\$even|\$odd|\$parent)$/.test(p)))throw d("badident",p);var v,x,t,y,z={$id:La};return n?v=a(n):(t=function(a,c){return La(c)},y=function(a){return a}),function(a,f,g,l,n){v&&(x=function(c,d,e){return J&&(z[J]=c),z[s]=d,z.$index=e,v(a,z)});var m=wa();a.$watchCollection(q,function(g){var l,q,H,C,Q,A,E,w,B,F,z=f[0],v=wa();if(p&&(a[p]=g),Ra(g))w=g,q=x||t;else{q=x||y,w=[];for(F in g)g.hasOwnProperty(F)&&"$"!=F.charAt(0)&&w.push(F);w.sort()}for(C=w.length,F=Array(C),l=0;C>l;l++)if(Q=g===w?l:w[l],A=g[Q],E=q(Q,A,l),m[E])B=m[E],delete m[E],v[E]=B,F[l]=B;else{if(v[E])throw r(F,function(a){a&&a.scope&&(m[a.id]=a)}),d("dupes",k,E,ra(A));F[l]={id:E,scope:u,clone:u},v[E]=!0}for(H in m){if(B=m[H],E=ob(B.clone),c.leave(E),E[0].parentNode)for(l=0,q=E.length;q>l;l++)E[l].$$NG_REMOVED=!0;B.scope.$destroy()}for(l=0;C>l;l++)if(Q=g===w?l:w[l],A=g[Q],B=F[l],B.scope){H=z;do H=H.nextSibling;while(H&&H.$$NG_REMOVED);B.clone[0]!=H&&c.move(ob(B.clone),null,D(z)),z=B.clone[B.clone.length-1],e(B.scope,l,s,A,J,Q,C)}else n(function(a,d){B.scope=d;var f=h.cloneNode(!1);a[a.length++]=f,c.enter(a,null,D(z)),z=f,B.clone=a,v[B.id]=B,e(B.scope,l,s,A,J,Q,C)});m=v})}}}}],je=["$animate",function(a){return{restrict:"A",multiElement:!0,link:function(c,d,e){c.$watch(e.ngShow,function(c){a[c?"removeClass":"addClass"](d,"ng-hide",{tempClasses:"ng-hide-animate"})})}}}],ce=["$animate",function(a){return{restrict:"A",multiElement:!0,link:function(c,d,e){c.$watch(e.ngHide,function(c){a[c?"addClass":"removeClass"](d,"ng-hide",{tempClasses:"ng-hide-animate"})})}}}],ke=Ha(function(a,c,d){a.$watch(d.ngStyle,function(a,d){d&&a!==d&&r(d,function(a,d){c.css(d,"")}),a&&c.css(a)},!0)}),le=["$animate",function(a){return{restrict:"EA",require:"ngSwitch",controller:["$scope",function(){this.cases={}}],link:function(c,d,e,f){var g=[],k=[],h=[],l=[],m=function(a,c){return function(){a.splice(c,1)}};c.$watch(e.ngSwitch||e.on,function(c){var d,e;for(d=0,e=h.length;e>d;++d)a.cancel(h[d]);for(d=h.length=0,e=l.length;e>d;++d){var s=ob(k[d].clone);l[d].$destroy(),(h[d]=a.leave(s)).then(m(h,d))}k.length=0,l.length=0,(g=f.cases["!"+c]||f.cases["?"])&&r(g,function(c){c.transclude(function(d,e){l.push(e);var f=c.element;d[d.length++]=X.createComment(" end ngSwitchWhen: "),k.push({clone:d}),a.enter(d,f.parent(),f)})})})}}}],me=Ha({transclude:"element",priority:1200,require:"^ngSwitch",multiElement:!0,link:function(a,c,d,e,f){e.cases["!"+d.ngSwitchWhen]=e.cases["!"+d.ngSwitchWhen]||[],e.cases["!"+d.ngSwitchWhen].push({transclude:f,element:c})}}),ne=Ha({transclude:"element",priority:1200,require:"^ngSwitch",multiElement:!0,link:function(a,c,d,e,f){e.cases["?"]=e.cases["?"]||[],e.cases["?"].push({transclude:f,element:c})}}),pe=Ha({restrict:"EAC",link:function(a,c,d,e,f){if(!f)throw y("ngTransclude")("orphan",sa(c));f(function(a){c.empty(),c.append(a)})}}),Qd=["$templateCache",function(a){return{restrict:"E",terminal:!0,compile:function(c,d){"text/ng-template"==d.type&&a.put(d.id,c[0].text)}}}],Rf=y("ngOptions"),oe=da({restrict:"A",terminal:!0}),Rd=["$compile","$parse",function(a,c){var d=/^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/,e={$setViewValue:A};return{restrict:"E",require:["select","?ngModel"],controller:["$element","$scope","$attrs",function(a,c,d){var q,h=this,l={},m=e;h.databound=d.ngModel,h.init=function(a,c,d){m=a,q=d},h.addOption=function(c,d){Ka(c,'"option value"'),l[c]=!0,m.$viewValue==c&&(a.val(c),q.parent()&&q.remove()),d&&d[0].hasAttribute("selected")&&(d[0].selected=!0)},h.removeOption=function(a){this.hasOption(a)&&(delete l[a],m.$viewValue==a&&this.renderUnknownOption(a))},h.renderUnknownOption=function(c){c="? "+La(c)+" ?",q.val(c),a.prepend(q),a.val(c),q.prop("selected",!0)},h.hasOption=function(a){return l.hasOwnProperty(a)},c.$on("$destroy",function(){h.renderUnknownOption=A})}],link:function(e,g,k,h){function l(a,c,d,e){d.$render=function(){var a=d.$viewValue;e.hasOption(a)?(C.parent()&&C.remove(),c.val(a),""===a&&v.prop("selected",!0)):w(a)&&v?c.val(""):e.renderUnknownOption(a)},c.on("change",function(){a.$apply(function(){C.parent()&&C.remove(),d.$setViewValue(c.val())})})}function m(a,c,d){var e;d.$render=function(){var a=new bb(d.$viewValue);r(c.find("option"),function(c){c.selected=z(a.get(c.value))})},a.$watch(function(){la(e,d.$viewValue)||(e=qa(d.$viewValue),d.$render())}),c.on("change",function(){a.$apply(function(){var a=[];r(c.find("option"),function(c){c.selected&&a.push(c.value)}),d.$setViewValue(a)})})}function q(e,f,g){function h(a,c,d){return N[A]=d,F&&(N[F]=c),a(e,N)}function k(a){var c;if(n)if(G&&B(a)){c=new bb([]);for(var d=0;d<a.length;d++)c.put(h(G,null,a[d]),!0)}else c=new bb(a);else G&&(a=h(G,null,a));return function(d,e){var f;return f=G?G:w?w:I,n?z(c.remove(h(f,d,e))):a==h(f,d,e)}}function l(){x||(e.$$postDigest(q),x=!0)}function m(a,c,d){a[c]=a[c]||0,a[c]+=d?1:-1}function q(){x=!1;var d,l,s,u,v,a={"":[]},c=[""];s=g.$viewValue,u=P(e)||[];var w,B,D,I,G,A=F?ic(u):u,N={};I=k(s),v=!1;var S;for(G=0;D=A.length,D>G;G++)w=G,F&&(w=A[G],"$"===w.charAt(0))||(B=u[w],d=h(M,w,B)||"",(l=a[d])||(l=a[d]=[],c.push(d)),d=I(w,B),v=v||d,w=h(C,w,B),w=z(w)?w:"",l.push({id:F?A[G]:G,label:w,selected:d}));for(n||(y||null===s?a[""].unshift({id:"",label:"",selected:!v}):v||a[""].unshift({id:"?",label:"",selected:!0})),I=0,A=c.length;A>I;I++){for(d=c[I],l=a[d],R.length<=I?(s={element:E.clone().attr("label",d),label:l.label},u=[s],R.push(u),f.append(s.element)):(u=R[I],s=u[0],s.label!=d&&s.element.attr("label",s.label=d)),w=null,G=0,D=l.length;D>G;G++)d=l[G],(v=u[G+1])?(w=v.element,v.label!==d.label&&(m(N,v.label,!1),m(N,d.label,!0),w.text(v.label=d.label)),v.id!==d.id&&w.val(v.id=d.id),w[0].selected!==d.selected&&(w.prop("selected",v.selected=d.selected),Pa&&w.prop("selected",v.selected))):(""===d.id&&y?S=y:(S=t.clone()).val(d.id).prop("selected",d.selected).attr("selected",d.selected).text(d.label),u.push(v={element:S,label:d.label,id:d.id,selected:d.selected}),m(N,d.label,!0),w?w.after(S):s.element.append(S),w=S);for(G++;u.length>G;)d=u.pop(),m(N,d.label,!1),d.element.remove();r(N,function(a,c){a>0?p.addOption(c):0>a&&p.removeOption(c)})}for(;R.length>I;)R.pop()[0].element.remove()}var v;if(!(v=s.match(d)))throw Rf("iexp",s,sa(f));var C=c(v[2]||v[1]),A=v[4]||v[6],D=/ as /.test(v[0])&&v[1],w=D?c(D):null,F=v[5],M=c(v[3]||""),I=c(v[2]?v[1]:A),P=c(v[7]),G=v[8]?c(v[8]):null,R=[[{element:f,label:""}]],N={};y&&(a(y)(e),y.removeClass("ng-scope"),y.remove()),f.empty(),f.on("change",function(){e.$apply(function(){var c,a=P(e)||[];if(n)c=[],r(f.val(),function(d){c.push("?"===d?u:""===d?null:h(w?w:I,d,a[d]))});else{var d=f.val();c="?"===d?u:""===d?null:h(w?w:I,d,a[d])}g.$setViewValue(c),q()})}),g.$render=q,e.$watchCollection(P,l),e.$watchCollection(function(){var c,a=P(e);if(a&&B(a)){c=Array(a.length);for(var d=0,f=a.length;f>d;d++)c[d]=h(C,d,a[d])}else if(a)for(d in c={},a)a.hasOwnProperty(d)&&(c[d]=h(C,d,a[d]));return c},l),n&&e.$watchCollection(function(){return g.$modelValue},l)}if(h[1]){var p=h[0];h=h[1];var v,n=k.multiple,s=k.ngOptions,y=!1,x=!1,t=D(X.createElement("option")),E=D(X.createElement("optgroup")),C=t.clone();k=0;for(var A=g.children(),F=A.length;F>k;k++)if(""===A[k].value){v=y=A.eq(k);break}p.init(h,y,C),n&&(h.$isEmpty=function(a){return!a||0===a.length}),s?q(e,g,h):n?m(e,g,h):l(e,g,h,p)}}}}],Td=["$interpolate",function(a){var c={addOption:A,removeOption:A};return{restrict:"E",priority:100,compile:function(d,e){if(w(e.value)){var f=a(d.text(),!0);f||e.$set("value",d.text())}return function(a,d,e){var l=d.parent(),m=l.data("$selectController")||l.parent().data("$selectController");m&&m.databound||(m=c),f?a.$watch(f,function(a,c){e.$set("value",a),c!==a&&m.removeOption(c),m.addOption(a,d)}):m.addOption(e.value,d),d.on("$destroy",function(){m.removeOption(e.value)})}}}}],Sd=da({restrict:"E",terminal:!1});S.angular.bootstrap?console.log("WARNING: Tried to load angular more than once."):(Id(),Kd(ta),D(X).ready(function(){Ed(X,rc)}))}(window,document),!window.angular.$$csp()&&window.angular.element(document).find("head").prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\\:form{display:block;}</style>'),function(n,e){"use strict";function x(s,g,h){return{restrict:"ECA",terminal:!0,priority:400,transclude:"element",link:function(a,c,b,f,w){function y(){p&&(p.remove(),p=null),k&&(k.$destroy(),k=null),l&&(h.leave(l,function(){p=null}),p=l,l=null)}function v(){var b=s.current&&s.current.locals;if(e.isDefined(b&&b.$template)){var b=a.$new(),d=s.current;l=w(b,function(d){h.enter(d,null,l||c,function(){!e.isDefined(t)||t&&!a.$eval(t)||g()}),y()}),k=d.scope=b,k.$emit("$viewContentLoaded"),k.$eval(u)}else y()}var k,l,p,t=b.autoscroll,u=b.onload||"";a.$on("$routeChangeSuccess",v),v()}}}function z(e,g,h){return{restrict:"ECA",priority:-400,link:function(a,c){var b=h.current,f=b.locals;c.html(f.$template);var w=e(c.contents());b.controller&&(f.$scope=a,f=g(b.controller,f),b.controllerAs&&(a[b.controllerAs]=f),c.data("$ngControllerController",f),c.children().data("$ngControllerController",f)),w(a)}}}n=e.module("ngRoute",["ng"]).provider("$route",function(){function s(a,c){return e.extend(new(e.extend(function(){},{prototype:a})),c)}function g(a,e){var b=e.caseInsensitiveMatch,f={originalPath:a,regexp:a},h=f.keys=[];return a=a.replace(/([().])/g,"\\$1").replace(/(\/)?:(\w+)([\?\*])?/g,function(a,e,b,c){return a="?"===c?c:null,c="*"===c?c:null,h.push({name:b,optional:!!a}),e=e||"",""+(a?"":e)+"(?:"+(a?e:"")+(c&&"(.+?)"||"([^/]+)")+(a||"")+")"+(a||"")}).replace(/([\/$\*])/g,"\\$1"),f.regexp=RegExp("^"+a+"$",b?"i":""),f}var h={};this.when=function(a,c){if(h[a]=e.extend({reloadOnSearch:!0},c,a&&g(a,c)),a){var b="/"==a[a.length-1]?a.substr(0,a.length-1):a+"/";h[b]=e.extend({redirectTo:a},g(b,c))}return this},this.otherwise=function(a){return this.when(null,a),this},this.$get=["$rootScope","$location","$routeParams","$q","$injector","$http","$templateCache","$sce",function(a,c,b,f,g,n,v,k){function l(){var d=p(),m=r.current;d&&m&&d.$$route===m.$$route&&e.equals(d.pathParams,m.pathParams)&&!d.reloadOnSearch&&!u?(m.params=d.params,e.copy(m.params,b),a.$broadcast("$routeUpdate",m)):(d||m)&&(u=!1,a.$broadcast("$routeChangeStart",d,m),(r.current=d)&&d.redirectTo&&(e.isString(d.redirectTo)?c.path(t(d.redirectTo,d.params)).search(d.params).replace():c.url(d.redirectTo(d.pathParams,c.path(),c.search())).replace()),f.when(d).then(function(){if(d){var c,b,a=e.extend({},d.resolve);return e.forEach(a,function(d,c){a[c]=e.isString(d)?g.get(d):g.invoke(d)}),e.isDefined(c=d.template)?e.isFunction(c)&&(c=c(d.params)):e.isDefined(b=d.templateUrl)&&(e.isFunction(b)&&(b=b(d.params)),b=k.getTrustedResourceUrl(b),e.isDefined(b)&&(d.loadedTemplateUrl=b,c=n.get(b,{cache:v}).then(function(a){return a.data}))),e.isDefined(c)&&(a.$template=c),f.all(a)}}).then(function(c){d==r.current&&(d&&(d.locals=c,e.copy(d.params,b)),a.$broadcast("$routeChangeSuccess",d,m))},function(c){d==r.current&&a.$broadcast("$routeChangeError",d,m,c)}))}function p(){var a,b;return e.forEach(h,function(f){var q;if(q=!b){var g=c.path();q=f.keys;var l={};if(f.regexp)if(g=f.regexp.exec(g)){for(var k=1,p=g.length;p>k;++k){var n=q[k-1],r=g[k];n&&r&&(l[n.name]=r)}q=l}else q=null;else q=null;q=a=q}q&&(b=s(f,{params:e.extend({},c.search(),a),pathParams:a}),b.$$route=f)}),b||h[null]&&s(h[null],{params:{},pathParams:{}})}function t(a,c){var b=[];return e.forEach((a||"").split(":"),function(a,d){if(0===d)b.push(a);else{var e=a.match(/(\w+)(.*)/),f=e[1];b.push(c[f]),b.push(e[2]||""),delete c[f]}}),b.join("")}var u=!1,r={routes:h,reload:function(){u=!0,a.$evalAsync(l)}};return a.$on("$locationChangeSuccess",l),r}]}),n.provider("$routeParams",function(){this.$get=function(){return{}}}),n.directive("ngView",x),n.directive("ngView",z),x.$inject=["$route","$anchorScroll","$animate"],z.$inject=["$compile","$controller","$route"]}(window,window.angular),function(p,f,n){"use strict";f.module("ngCookies",["ng"]).factory("$cookies",["$rootScope","$browser",function(e,b){var h,c={},g={},k=!1,l=f.copy,m=f.isUndefined;return b.addPollFn(function(){var a=b.cookies();h!=a&&(h=a,l(a,g),l(a,c),k&&e.$apply())})(),k=!0,e.$watch(function(){var a,d,e;for(a in g)m(c[a])&&b.cookies(a,n);for(a in c)d=c[a],f.isString(d)||(d=""+d,c[a]=d),d!==g[a]&&(b.cookies(a,d),e=!0);if(e)for(a in d=b.cookies(),c)c[a]!==d[a]&&(m(d[a])?delete c[a]:c[a]=d[a])}),c}]).factory("$cookieStore",["$cookies",function(e){return{get:function(b){return(b=e[b])?f.fromJson(b):b},put:function(b,c){e[b]=f.toJson(c)},remove:function(b){delete e[b]}}}])}(window,window.angular),!function(){var a=angular.module("angularFileUpload",[]);a.service("$upload",["$http","$q","$timeout",function(a,b,c){function d(d){d.method=d.method||"POST",d.headers=d.headers||{},d.transformRequest=d.transformRequest||function(b,c){return window.ArrayBuffer&&b instanceof window.ArrayBuffer?b:a.defaults.transformRequest[0](b,c)};var e=b.defer();window.XMLHttpRequest.__isShim&&(d.headers.__setXHR_=function(){return function(a){a&&(d.__XHR=a,d.xhrFn&&d.xhrFn(a),a.upload.addEventListener("progress",function(a){e.notify(a)},!1),a.upload.addEventListener("load",function(a){a.lengthComputable&&e.notify(a)},!1))}}),a(d).then(function(a){e.resolve(a)},function(a){e.reject(a)},function(a){e.notify(a)});var f=e.promise;return f.success=function(a){return f.then(function(b){a(b.data,b.status,b.headers,d)}),f},f.error=function(a){return f.then(null,function(b){a(b.data,b.status,b.headers,d)}),f},f.progress=function(a){return f.then(null,null,function(b){a(b)}),f},f.abort=function(){return d.__XHR&&c(function(){d.__XHR.abort()}),f},f.xhr=function(a){return d.xhrFn=function(b){return function(){b&&b.apply(f,arguments),a.apply(f,arguments)}}(d.xhrFn),f},f}this.upload=function(b){b.headers=b.headers||{},b.headers["Content-Type"]=void 0,b.transformRequest=b.transformRequest||a.defaults.transformRequest;var c=new FormData,e=b.transformRequest,f=b.data;return b.transformRequest=function(a,c){if(f)if(b.formDataAppender)for(var d in f){var g=f[d];b.formDataAppender(a,d,g)}else for(var d in f){var g=f[d];if("function"==typeof e)g=e(g,c);else for(var h=0;h<e.length;h++){var i=e[h];"function"==typeof i&&(g=i(g,c))}a.append(d,g)}if(null!=b.file){var j=b.fileFormDataName||"file";if("[object Array]"===Object.prototype.toString.call(b.file))for(var k="[object String]"===Object.prototype.toString.call(j),h=0;h<b.file.length;h++)a.append(k?j:j[h],b.file[h],b.fileName&&b.fileName[h]||b.file[h].name);else a.append(j,b.file,b.fileName||b.file.name)}return a},b.data=c,d(b)},this.http=function(a){return d(a)}}]),a.directive("ngFileSelect",["$parse","$timeout",function(a,b){return function(c,d,e){var f=a(e.ngFileSelect);if("input"!==d[0].tagName.toLowerCase()||"file"!==(d.attr("type")&&d.attr("type").toLowerCase())){for(var g=angular.element('<input type="file">'),h=d[0].attributes,i=0;i<h.length;i++)"type"!==h[i].name.toLowerCase()&&g.attr(h[i].name,h[i].value);e.multiple&&g.attr("multiple","true"),g.css("width","1px").css("height","1px").css("opacity",0).css("position","absolute").css("filter","alpha(opacity=0)").css("padding",0).css("margin",0).css("overflow","hidden"),g.attr("__wrapper_for_parent_",!0),d.append(g),d[0].__file_click_fn_delegate_=function(){g[0].click()},d.bind("click",d[0].__file_click_fn_delegate_),d.css("overflow","hidden"),d=g}d.bind("change",function(a){var d,e,g=[];if(d=a.__files_||a.target.files,null!=d)for(e=0;e<d.length;e++)g.push(d.item(e));b(function(){f(c,{$files:g,$event:a})})})}}]),a.directive("ngFileDropAvailable",["$parse","$timeout",function(a,b){return function(c,d,e){if("draggable"in document.createElement("span")){var f=a(e.ngFileDropAvailable);b(function(){f(c)})}}}]),a.directive("ngFileDrop",["$parse","$timeout","$location",function(a,b,c){return function(d,e,f){function g(a){return/^[\000-\177]*$/.test(a)}function h(a,d){var e=[],f=a.dataTransfer.items;if(f&&f.length>0&&f[0].webkitGetAsEntry&&"file"!=c.protocol()&&f[0].webkitGetAsEntry().isDirectory)for(var h=0;h<f.length;h++){var j=f[h].webkitGetAsEntry();null!=j&&(g(j.name)?i(e,j):f[h].webkitGetAsEntry().isDirectory||e.push(f[h].getAsFile()))}else{var k=a.dataTransfer.files;if(null!=k)for(var h=0;h<k.length;h++)e.push(k.item(h))}!function m(a){b(function(){l?m(10):d(e)},a||0)}()}function i(a,b,c){if(null!=b)if(b.isDirectory){var d=b.createReader();l++,d.readEntries(function(d){for(var e=0;e<d.length;e++)i(a,d[e],(c?c:"")+b.name+"/");l--})}else l++,b.file(function(b){l--,b._relativePath=(c?c:"")+b.name,a.push(b)})}if("draggable"in document.createElement("span")){var j=null;e[0].addEventListener("dragover",function(c){if(c.preventDefault(),b.cancel(j),!e[0].__drag_over_class_)if(f.ngFileDragOverClass&&f.ngFileDragOverClass.search(/\) *$/)>-1){var g=a(f.ngFileDragOverClass)(d,{$event:c});e[0].__drag_over_class_=g}else e[0].__drag_over_class_=f.ngFileDragOverClass||"dragover";e.addClass(e[0].__drag_over_class_)},!1),e[0].addEventListener("dragenter",function(a){a.preventDefault()},!1),e[0].addEventListener("dragleave",function(){j=b(function(){e.removeClass(e[0].__drag_over_class_),e[0].__drag_over_class_=null},f.ngFileDragOverDelay||1)},!1);var k=a(f.ngFileDrop);e[0].addEventListener("drop",function(a){a.preventDefault(),e.removeClass(e[0].__drag_over_class_),e[0].__drag_over_class_=null,h(a,function(b){k(d,{$files:b,$event:a})})},!1);var l=0}}}])}(),function(q,g,r){"use strict";function F(a){var d=[];return t(d,g.noop).chars(a),d.join("")}function m(a){var d={};a=a.split(",");var c;for(c=0;c<a.length;c++)d[a[c]]=!0;return d}function G(a,d){function c(a,b,c,h){if(b=g.lowercase(b),u[b])for(;f.last()&&v[f.last()];)e("",f.last());w[b]&&f.last()==b&&e("",b),(h=x[b]||!!h)||f.push(b);var n={};c.replace(H,function(a,b,d,c,e){n[b]=s(d||c||e||"")}),d.start&&d.start(b,n,h)}function e(a,b){var e,c=0;if(b=g.lowercase(b))for(c=f.length-1;c>=0&&f[c]!=b;c--);if(c>=0){for(e=f.length-1;e>=c;e--)d.end&&d.end(f[e]);f.length=c}}"string"!=typeof a&&(a=null===a||"undefined"==typeof a?"":""+a);var b,l,h,f=[],n=a;for(f.last=function(){return f[f.length-1]};a;){if(h="",l=!0,f.last()&&y[f.last()]?(a=a.replace(RegExp("(.*)<\\s*\\/\\s*"+f.last()+"[^>]*>","i"),function(a,b){return b=b.replace(I,"$1").replace(J,"$1"),d.chars&&d.chars(s(b)),""}),e("",f.last())):(0===a.indexOf("<!--")?(b=a.indexOf("--",4),b>=0&&a.lastIndexOf("-->",b)===b&&(d.comment&&d.comment(a.substring(4,b)),a=a.substring(b+3),l=!1)):z.test(a)?(b=a.match(z))&&(a=a.replace(b[0],""),l=!1):K.test(a)?(b=a.match(A))&&(a=a.substring(b[0].length),b[0].replace(A,e),l=!1):L.test(a)&&((b=a.match(B))?(b[4]&&(a=a.substring(b[0].length),b[0].replace(B,c)),l=!1):(h+="<",a=a.substring(1))),l&&(b=a.indexOf("<"),h+=0>b?a:a.substring(0,b),a=0>b?"":a.substring(b),d.chars&&d.chars(s(h)))),a==n)throw M("badparse",a);n=a}e()}function s(a){if(!a)return"";var d=N.exec(a);a=d[1];var c=d[3];return(d=d[2])&&(p.innerHTML=d.replace(/</g,"&lt;"),d="textContent"in p?p.textContent:p.innerText),a+d+c}function C(a){return a.replace(/&/g,"&amp;").replace(O,function(a){var c=a.charCodeAt(0);return a=a.charCodeAt(1),"&#"+(1024*(c-55296)+(a-56320)+65536)+";"}).replace(P,function(a){return"&#"+a.charCodeAt(0)+";"}).replace(/</g,"&lt;").replace(/>/g,"&gt;")}function t(a,d){var c=!1,e=g.bind(a,a.push);return{start:function(a,l,f){a=g.lowercase(a),!c&&y[a]&&(c=a),c||!0!==D[a]||(e("<"),e(a),g.forEach(l,function(c,f){var k=g.lowercase(f),l="img"===a&&"src"===k||"background"===k;!0!==Q[k]||!0===E[k]&&!d(c,l)||(e(" "),e(f),e('="'),e(C(c)),e('"'))}),e(f?"/>":">"))},end:function(a){a=g.lowercase(a),c||!0!==D[a]||(e("</"),e(a),e(">")),a==c&&(c=!1)},chars:function(a){c||e(C(a))}}}var M=g.$$minErr("$sanitize"),B=/^<((?:[a-zA-Z])[\w:-]*)((?:\s+[\w:-]+(?:\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|[^>\s]+))?)*)\s*(\/?)\s*(>?)/,A=/^<\/\s*([\w:-]+)[^>]*>/,H=/([\w:-]+)(?:\s*=\s*(?:(?:"((?:[^"])*)")|(?:'((?:[^'])*)')|([^>\s]+)))?/g,L=/^</,K=/^<\//,I=/\x3c!--(.*?)--\x3e/g,z=/<!DOCTYPE([^>]*?)>/i,J=/<!\[CDATA\[(.*?)]]\x3e/g,O=/[\uD800-\uDBFF][\uDC00-\uDFFF]/g,P=/([^\#-~| |!])/g,x=m("area,br,col,hr,img,wbr");q=m("colgroup,dd,dt,li,p,tbody,td,tfoot,th,thead,tr"),r=m("rp,rt");var w=g.extend({},r,q),u=g.extend({},q,m("address,article,aside,blockquote,caption,center,del,dir,div,dl,figure,figcaption,footer,h1,h2,h3,h4,h5,h6,header,hgroup,hr,ins,map,menu,nav,ol,pre,script,section,table,ul")),v=g.extend({},r,m("a,abbr,acronym,b,bdi,bdo,big,br,cite,code,del,dfn,em,font,i,img,ins,kbd,label,map,mark,q,ruby,rp,rt,s,samp,small,span,strike,strong,sub,sup,time,tt,u,var")),y=m("script,style"),D=g.extend({},x,u,v,w),E=m("background,cite,href,longdesc,src,usemap"),Q=g.extend({},E,m("abbr,align,alt,axis,bgcolor,border,cellpadding,cellspacing,class,clear,color,cols,colspan,compact,coords,dir,face,headers,height,hreflang,hspace,ismap,lang,language,nohref,nowrap,rel,rev,rows,rowspan,rules,scope,scrolling,shape,size,span,start,summary,target,title,type,valign,value,vspace,width")),p=document.createElement("pre"),N=/^(\s*)([\s\S]*?)(\s*)$/;g.module("ngSanitize",[]).provider("$sanitize",function(){this.$get=["$$sanitizeUri",function(a){return function(d){var c=[];return G(d,t(c,function(c,b){return!/^unsafe/.test(a(c,b))})),c.join("")}}]}),g.module("ngSanitize").filter("linky",["$sanitize",function(a){var d=/((ftp|https?):\/\/|(mailto:)?[A-Za-z0-9._%+-]+@)\S*[^\s.;,(){}<>"]/,c=/^mailto:/;return function(e,b){function l(a){a&&k.push(F(a))}function f(a,c){k.push("<a "),g.isDefined(b)&&(k.push('target="'),k.push(b),k.push('" ')),k.push('href="'),k.push(a),k.push('">'),l(c),k.push("</a>")}if(!e)return e;for(var n,m,p,h=e,k=[];n=h.match(d);)m=n[0],n[2]==n[3]&&(m="mailto:"+m),p=n.index,l(h.substr(0,p)),f(m,n[0].replace(c,"")),h=h.substring(p+n[0].length);return l(h),a(k.join(""))}}])}(window,window.angular);var app=angular.module("yossarian",["ngRoute","ngCookies","ngSanitize","ui.highlight","angularFileUpload","dashboard","docs","calendar","projects","contacts","settings"]);app.config(["$routeProvider","$locationProvider",function($routeProvider,$locationProvider){$routeProvider.when("/",{templateUrl:"partials/dashboard/main",controller:"dashboardController"}).when("/dashboard",{redirectTo:"/"}).when("/docs/:slug/update",{templateUrl:"partials/docs/update",controller:"docsUpdate"}).when("/docs/create",{templateUrl:"partials/docs/create",controller:"docsCreate"}).when("/docs/:slug",{templateUrl:"partials/docs/main",controller:"docsController"}).when("/docs",{templateUrl:"partials/docs/main",controller:"docsController"}).when("/calendar",{templateUrl:"partials/calendar/main",controller:"calendarController"}).when("/calendar/:year/:month",{templateUrl:"partials/calendar/main",controller:"calendarController"}).when("/projects/:slug/update",{templateUrl:"partials/projects/update",controller:"projectsForm"}).when("/projects/create",{templateUrl:"partials/projects/create",controller:"projectsForm"}).when("/projects/:slug",{templateUrl:"partials/projects/detail",controller:"projectsDetail"}).when("/projects",{templateUrl:"partials/projects/main",controller:"projectsController"}).when("/contacts",{templateUrl:"partials/contacts/main",controller:"contactsController"}).when("/settings/:option",{templateUrl:"partials/settings/main",controller:"settingsController"}).when("/settings",{templateUrl:"partials/settings/main",controller:"settingsController"}).otherwise({redirectTo:"/"}),$locationProvider.html5Mode(!1)}]),app.controller("global",["$scope","$rootScope","$http",function($scope,$rootScope,$http){$rootScope.masthead="Yossarian",$rootScope.seperator=" — ",$rootScope.menu=[{slug:"dashboard",name:"Dashboard"},{slug:"docs",name:"Knowledge base"},{slug:"calendar",name:"Calendar"},{slug:"projects",name:"Projects"},{slug:"contacts",name:"Contacts"}],$rootScope.user={},$http.post("/users/user").success(function(userData){$rootScope.user=userData}),$rootScope.message={},$rootScope.categoryList=[],$http.post("/categories/list").success(function(categoryData){$rootScope.categoryList=categoryData}),$rootScope.markdownURL="https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet",$rootScope.fromNow=function(date){return moment(date).fromNow()},$rootScope.fromNowDays=function(date){var today=moment().format();return moment(date).diff(today,"days")<1?"Now":moment(date).diff(today,"days")+"d"},$rootScope.durationDays=function(start,end){return moment(end).diff(start,"days")<1?"1d":moment(end).diff(start,"days")+1+"d"},$rootScope.daysFromNow=function(date){return moment(date).fromNow("dd")},$rootScope.displayDate=function(date){return moment(date).format("DD/MM/YYYY")},$rootScope.slugify=function(text){return text.toString().toLowerCase().replace(/\s+/g,"-").replace(/[^\w\-]+/g,"").replace(/\-\-+/g,"-").replace(/^-+/,"").replace(/-+$/,"")},$rootScope.morphColor=function(col,amt){var usePound=!1;"#"==col[0]&&(col=col.slice(1),usePound=!0);var num=parseInt(col,16),r=(num>>16)+amt;r>255?r=255:0>r&&(r=0);var b=(num>>8&255)+amt;b>255?b=255:0>b&&(b=0);var g=(255&num)+amt;return g>255?g=255:0>g&&(g=0),(usePound?"#":"")+(g|b<<8|r<<16).toString(16)}}]),angular.module("ui.highlight",[]).filter("highlight",function(){return function(text,search,caseSensitive){return text&&(search||angular.isNumber(search))?(text=text.toString(),search=search.toString(),caseSensitive?text.split(search).join("<mark>"+search+"</mark>"):text.replace(new RegExp(search,"gi"),"<mark>$&</mark>")):text}});var ctrl=angular.module("dashboard",[]);ctrl.controller("dashboardController",["$scope","$rootScope","$cookies",function($scope,$rootScope,$cookies){$rootScope.slug="dashboard",$rootScope.heading="Dashboard",$rootScope.moniker=$rootScope.heading+$rootScope.seperator+$rootScope.masthead,$scope.dashMenu=[{name:"News",slug:"news",url:"/partials/dashboard/news"},{name:"People",slug:"people",url:"/partials/dashboard/people"},{name:"Addresses",slug:"addresses",url:"/partials/dashboard/addresses"},{name:"Links",slug:"links",url:"/partials/dashboard/links"}],$scope.dashActive=$scope.dashMenu[0],$cookies.dashActive&&($scope.dashActive=$scope.dashMenu[$cookies.dashActive]),$rootScope.moniker=$scope.dashActive.name+" « "+$rootScope.heading+$rootScope.seperator+$rootScope.masthead,$scope.dashMenuClick=function(index){$scope.dashActive=$scope.dashMenu[index],$cookies.dashActive=index,$rootScope.moniker=$scope.dashActive.name+" « "+$rootScope.heading+$rootScope.seperator+$rootScope.masthead}}]),ctrl.controller("dashboardNews",["$scope","$http","$cookies",function($scope,$http,$cookies){$scope.memoPage=0,$scope.memoPages=0,$scope.memoLimit=10,$scope.memos=[],$scope.getMemos=function(){$http.post("/memos/list",{limit:$scope.memoLimit,skip:$scope.memoPage}).success(function(memoData){$scope.memos=memoData,$scope.memoPages=Math.ceil(memoData.count/$scope.memoLimit)})},$scope.getMemos(),$scope.createMemo=function(){$http.post("/memos/create",{memo:$scope.newMemo}).success(function(){$scope.freshMemo=!1,$scope.newMemo="",$scope.getMemos()})},$scope.removeMemo=function(id){$http.post("/memos/remove",{remove:id}).success(function(){$scope.freshMemo=!1,$scope.newMemo="",$scope.getMemos()})},$scope.navMemo=function(direction){"next"==direction&&($scope.memoPage=$scope.memoPage+1),"prev"==direction&&($scope.memoPage=$scope.memoPage-1),$scope.getMemos()},$scope.changePage=0,$scope.changePages=0,$scope.changeLimit=15,$scope.changelog=[],$scope.getChangelog=function(){$http.post("/changes/list",{limit:$scope.changeLimit,skip:$scope.changePage}).success(function(changeData){$scope.changelog=changeData,$scope.changePages=Math.ceil(changeData.count/$scope.changeLimit)})},$scope.getChangelog(),$scope.navChange=function(direction){"next"==direction&&($scope.changePage=$scope.changePage+1),"prev"==direction&&($scope.changePage=$scope.changePage-1),$scope.getChangelog()},$cookies.eventFilter||($cookies.eventFilter=[]),$scope.eventFilter="string"==typeof $cookies.eventFilter?$cookies.eventFilter.split(","):$cookies.eventFilter,$scope.categoryToggle=function(id){if($scope.eventFilter.indexOf(id)>-1){var index=$scope.eventFilter.indexOf(id);$scope.eventFilter.splice(index,1)}else-1==$scope.eventFilter.indexOf(id)&&$scope.eventFilter.push(id);$cookies.eventFilter=$scope.eventFilter},$scope.upcomingEvents=[],$scope.getUpcoming=function(){$http.post("/calendar/upcoming",{categories:$scope.eventFilter}).success(function(upcomingData){$scope.upcomingEvents=upcomingData;for(i in $scope.upcomingEvents)if($scope.upcomingEvents[i].period=moment($scope.upcomingEvents[i].start).format("DD/MM"),$scope.upcomingEvents[i].end){var start=moment($scope.upcomingEvents[i].start).format("DD/MM"),end=moment($scope.upcomingEvents[i].end).format("DD/MM");$scope.upcomingEvents[i].period=start+" - "+end}})},$scope.getUpcoming(),$scope.$watch("eventFilter",function(){$scope.getUpcoming()},!0),$scope.removeEventCategories=function(){$scope.eventFilter.length=0},$scope.upcomingClick=function(date){window.location.pathname="/#/calendar/"+moment(date).format("YYYY/MM")}}]);var ctrl=angular.module("docs",[]);ctrl.controller("docsController",["$scope","$rootScope","$routeParams","$http","$sce",function($scope,$rootScope,$routeParams,$http,$sce){$rootScope.slug="docs",$rootScope.heading="Knowledge base",$rootScope.moniker=$rootScope.heading+$rootScope.seperator+$rootScope.masthead,$scope.docsMenu=[],$http.post("/docs/menu").success(function(menu){if($scope.docsMenu=menu,$routeParams.slug)$scope.currentSlug=$routeParams.slug;else{var parentLess=[];for(i in $scope.docsMenu)"none"==$scope.docsMenu[i].parent&&parentLess.push($scope.docsMenu[i]);parentLess=parentLess.sort(function(low,high){return low.order-high.order}),$scope.currentSlug=parentLess[0].slug}$scope.currentDoc={},$http.post("/docs/detail",{slug:$scope.currentSlug}).success(function(docData){$scope.currentDoc=docData,$http.post("/marked",{text:$scope.currentDoc.body}).success(function(markedText){$scope.currentDoc.marked=$sce.trustAsHtml(markedText)}),$rootScope.heading=$scope.currentDoc.title+" « Knowledge base",$rootScope.moniker=$rootScope.heading+$rootScope.seperator+$rootScope.masthead})}),$scope.gotoDoc=function(slug){window.location.pathname="/#/docs/"+slug}}]),ctrl.controller("docsCreate",["$scope","$rootScope","$http","$sce",function($scope,$rootScope,$http,$sce){$rootScope.slug="docs",$rootScope.heading="Create document « Documents",$rootScope.moniker=$rootScope.heading+$rootScope.seperator+$rootScope.masthead;var uncategorized="";for(i in $rootScope.categoryList)"uncategorized"==$rootScope.categoryList[i].slug&&(uncategorized=$rootScope.categoryList[i]._id);
$scope.docParents=[],$http.post("/docs/menu").success(function(menu){$scope.docParents=menu}),$scope.createDoc={categories:[uncategorized],parent:"none"},$scope.categoryToggle=function(id){if($scope.createDoc.categories.indexOf(id)>-1){var index=$scope.createDoc.categories.indexOf(id);$scope.createDoc.categories.splice(index,1)}else-1==$scope.createDoc.categories.indexOf(id)&&$scope.createDoc.categories.push(id)},$scope.createDocument=function(){$scope.createDoc.slug=$rootScope.slugify($scope.createDoc.title),$scope.createDoc.postDate=moment(),$scope.createDoc.author=$rootScope.user._id,"None"==$scope.createDoc.title&&($scope.createDoc.title="No title"),$scope.createDoc.categories.length<1&&$scope.createDoc.categories.push(uncategorized),$http.post("/docs/create",$scope.createDoc).success(function(){window.location.pathname="/#/docs/"+$scope.createDoc.slug})},$scope.previewDocument=function(){$http.post("/marked",{text:$scope.createDoc.body}).success(function(markedText){$scope.previewVisible=!0,$scope.preview=$sce.trustAsHtml(markedText)})}}]),ctrl.controller("docsUpdate",["$scope","$rootScope","$routeParams","$http","$sce",function($scope,$rootScope,$routeParams,$http,$sce){$rootScope.slug="docs",$rootScope.heading="Update document « Documents",$rootScope.moniker=$rootScope.heading+$rootScope.seperator+$rootScope.masthead;var uncategorized="";for(i in $rootScope.categoryList)"uncategorized"==$rootScope.categoryList[i].slug&&(uncategorized=$rootScope.categoryList[i]._id);$scope.docParents=[],$http.post("/docs/menu").success(function(menu){$scope.docParents=menu}),$scope.updateSlug=$routeParams.slug,$scope.updateDoc={},$http.post("/docs/detail",{slug:$scope.updateSlug}).success(function(docData){var strippedCategories=[];for(i in docData.categories)strippedCategories.push(docData.categories[i]._id);docData.categories=strippedCategories,$scope.updateDoc=docData}),$scope.categoryToggle=function(id){if($scope.updateDoc.categories.indexOf(id)>-1){var index=$scope.updateDoc.categories.indexOf(id);$scope.updateDoc.categories.splice(index,1)}else-1==$scope.updateDoc.categories.indexOf(id)&&$scope.updateDoc.categories.push(id)},$scope.updateDocument=function(){$scope.updateDoc.slug=$rootScope.slugify($scope.updateDoc.title),$scope.updateDoc.editDate=moment(),$scope.updateDoc.author=$scope.updateDoc.author._id,$scope.updateDoc.editor=$rootScope.user._id,"None"==$scope.updateDoc.title&&($scope.updateDoc.title="No title"),$scope.updateDoc.categories.length<1&&$scope.updateDoc.categories.push(uncategorized),$http.post("/docs/update",$scope.updateDoc).success(function(){window.location.pathname="/#/docs/"+$scope.updateDoc.slug})},$scope.removeDoc=function(){var children=[];for(i in $scope.docParents)$scope.docParents[i].parent==$scope.updateDoc.slug&&children.push($scope.docParents[i].slug);children.length>0?alert("This document has child-documents. Unable to remove."):1==confirm("Are you sure you want to remove this document?")&&$http.post("/docs/remove",{remove:$scope.updateDoc._id,slug:$scope.updateDoc.slug,title:$scope.updateDoc.title}).success(function(){window.location.pathname="/#/docs"})},$scope.previewDocument=function(){$scope.preview?$scope.preview=!$scope.preview:$http.post("/marked",{text:$scope.updateDoc.body}).success(function(markedText){$scope.previewVisible=!0,$scope.preview=$sce.trustAsHtml(markedText)})}}]);var ctrl=angular.module("calendar",[]);ctrl.controller("calendarController",["$scope","$rootScope","$routeParams","$http","$cookies",function($scope,$rootScope,$routeParams,$http,$cookies){if($rootScope.slug="calendar",$scope.displayDate=moment(),$routeParams.year&&$routeParams.month){var dateCriteria=$routeParams.year+"-"+$routeParams.month;$scope.displayDate=moment(dateCriteria,"YYYY-MM")}$scope.actualMonth=moment().format("MMMM YYYY"),$scope.displayMonth=moment($scope.displayDate).format("MMMM YYYY"),$rootScope.heading=$scope.displayMonth+" « Calendar",$rootScope.moniker=$rootScope.heading+$rootScope.seperator+$rootScope.masthead,$scope.incident={},$scope.displayMin=moment($scope.displayDate).startOf("month").subtract("15","day"),$scope.displayMax=moment($scope.displayDate).endOf("month").add("15","day"),setTimeout(function(){$(".calendar-view").fullCalendar({firstDay:1,eventSources:[{url:"/calendar/list",method:"POST",data:{categories:$scope.eventFilter},error:function(){alert("there was an error while fetching events!")}}],dayRender:function(){var scope=angular.element("#main").scope();scope.$apply(function(){if(scope.incident.start){var start=moment(scope.incident.start,"DD/MM/YYYY");scope.startDate(start)}if(scope.incident.end){var end=moment(scope.incident.end,"DD/MM/YYYY");scope.endDate(end)}})},dayClick:function(date){var scope=angular.element("#main").scope();scope.$apply(function(){"update"==scope.eventOption.slug?$("#end").is(":visible")&&1!=scope.resetStart?scope.endDate(date):scope.startDate(date):(scope.eventPage(1),$("#end").is(":visible")&&1!=scope.resetStart?(scope.endDate(date),scope.rangeToggle()):scope.startDate(date))})},eventRender:function(event,element){element.css({"background-color":event.category.color}),element.attr("title",event.title+" ["+event.category.name+"]"),element.addClass(event._id)},eventMouseover:function(event){var scope=angular.element("#main").scope(),rootScope=scope.$root,hoverColor=rootScope.morphColor(event.category.color,40);$("."+event._id).css("background-color",hoverColor)},eventMouseout:function(event){$("."+event._id).css("background-color",event.category.color)},eventClick:function(event){var scope=angular.element("#main").scope();scope.$apply(function(){scope.eventPage(2),scope.getEvent(event)})}})},1),setTimeout(function(){$(".calendar-view").fullCalendar("gotoDate",$scope.displayDate)},1),$scope.eventOptions=[{name:"Default",slug:"default",url:"/partials/calendar/default"},{name:"Create event",slug:"create",url:"/partials/calendar/create"},{name:"Update event",slug:"update",url:"/partials/calendar/update"}],$scope.navMonth=function(arg){var gotoMonth=moment();"next"==arg?gotoMonth=moment($scope.displayDate).add("1","month"):"prev"==arg?gotoMonth=moment($scope.displayDate).subtract("1","month"):moment(arg).isValid&&(gotoMonth=arg),$scope.displayDate=moment(gotoMonth),$scope.displayMonth=moment(gotoMonth).format("MMMM YYYY"),$rootScope.heading=$scope.displayMonth+" « Calendar",$rootScope.moniker=$rootScope.heading+$rootScope.seperator+$rootScope.masthead,$(".calendar-view").fullCalendar("gotoDate",gotoMonth)},$scope.eventOption=$scope.eventOptions[0],$scope.eventPage=function(index){$scope.eventRange=!1,1==index&&"create"!=$scope.eventOption.slug&&($scope.incident={}),0==index&&$scope.getUpcoming(),$scope.eventOption=$scope.eventOptions[index]},$scope.getEvent=function(id){$http.post("/calendar/detail",id).success(function(incident){$scope.incident=incident,$(".fc-day").removeClass("start range end"),$scope.incident.start=moment($scope.incident.start).format("DD/MM/YYYY");var beginning=moment($scope.incident.start,"DD/MM/YYYY").format("YYYY-MM-DD");if($('.fc-day[data-date="'+beginning+'"]').addClass("start"),$scope.incident.end){$scope.rangeToggle(),$scope.incident.end=moment($scope.incident.end).format("DD/MM/YYYY");var finale=moment($scope.incident.end,"DD/MM/YYYY").format("YYYY-MM-DD");$('.fc-day[data-date="'+finale+'"]').addClass("end"),$scope.rangeMark($scope.incident.start,$scope.incident.end)}})},$scope.categoryToggle=function(id){if($scope.incident.categories.indexOf(id)>-1){var index=$scope.incident.categories.indexOf(id);$scope.incident.categories.splice(index,1)}else-1==$scope.incident.categories.indexOf(id)&&$scope.incident.categories.push(id)},$scope.rangeToggle=function(){$scope.eventRange=!$scope.eventRange,0==$scope.eventRange&&($scope.incident.end="",$(".fc-day").removeClass("end range"))},$scope.startDate=function(date){var dataDate=moment(date).format("YYYY-MM-DD");if($scope.incident.end){var checkDate=moment($scope.incident.end,"DD/MM/YYYY");moment(date).isBefore(checkDate)&&($(".fc-day").removeClass("start"),$('.fc-day[data-date="'+dataDate+'"]').addClass("start"),$scope.incident.start=moment(date).format("DD/MM/YYYY"),$scope.rangeMark($scope.incident.start,$scope.incident.end))}else $(".fc-day").removeClass("start"),$('.fc-day[data-date="'+dataDate+'"]').addClass("start"),$scope.incident.start=moment(date).format("DD/MM/YYYY");$scope.resetStart=!1},$scope.endDate=function(date){var dataDate=moment(date).format("YYYY-MM-DD"),checkDate=moment($scope.incident.start,"DD/MM/YYYY");moment(date).isAfter(checkDate)&&($scope.incident.end=moment(date).format("DD/MM/YYYY"),$(".fc-day").removeClass("end"),$('.fc-day[data-date="'+dataDate+'"]').addClass("end"),$scope.rangeMark($scope.incident.start,$scope.incident.end))},$scope.rangeMark=function(start,end){$(".fc-day").removeClass("range");var startRange=moment(start,"DD/MM/YYYY"),endRange=moment(end,"DD/MM/YYYY"),numDays=startRange.diff(endRange,"days");for(numDays=Math.abs(numDays),i=1;numDays>i;i++){var mark=moment(start,"DD/MM/YYYY").add(i,"day").format("YYYY-MM-DD");$('.fc-day[data-date="'+mark+'"]').addClass("range")}},$scope.resetStartDate=function(){$scope.incident.end&&($scope.resetStart=!0)},$scope.checkStart=function(){setTimeout(function(){if(moment($scope.incident.start,"DD/MM/YYYY").isValid()){var date=moment($scope.incident.start,"DD/MM/YYYY");$scope.startDate(date)}},500)},$scope.checkEnd=function(){setTimeout(function(){if(moment($scope.incident.end,"DD/MM/YYYY").isValid()){var date=moment($scope.incident.end,"DD/MM/YYYY");$scope.endDate(date)}},500)},$scope.incidentCancel=function(){$scope.eventPage(0),$scope.incident={},$scope.eventRange=!1,$(".fc-day").removeClass("start end range")},$scope.createEvent=function(){if($scope.incident.postDate=moment(),$scope.incident.author=$rootScope.user._id,!moment($scope.incident.start,"DD/MM/YYYY").isValid())return alert("Invalid start date");if($scope.incident.start=moment($scope.incident.start,"DD/MM/YYYY").startOf("day").add(2,"h").format(),$scope.incident.end){if(!moment($scope.incident.end,"DD/MM/YYYY").isValid())return alert("Invalid end date");$scope.incident.end=moment($scope.incident.end,"DD/MM/YYYY").endOf("day").format()}return $scope.incident.category?void $http.post("/calendar/create",$scope.incident).success(function(){$scope.navMonth($scope.incident.start),$scope.incident={},$scope.eventPage(0),$(".fc-day").removeClass("start end range"),$(".calendar-view").fullCalendar("refetchEvents")}):alert("Please assign a category")},$scope.updateEvent=function(){if($scope.incident.editDate=moment(),$scope.incident.author=$scope.incident.author._id,$scope.incident.editor=$rootScope.user._id,!moment($scope.incident.start,"DD/MM/YYYY").isValid())return alert("Invalid start date");if($scope.incident.start=moment($scope.incident.start,"DD/MM/YYYY").startOf("day").add(2,"h").format(),$scope.incident.end){if(!moment($scope.incident.end,"DD/MM/YYYY").isValid())return alert("Invalid end date");$scope.incident.end=moment($scope.incident.end,"DD/MM/YYYY").endOf("day").format()}return $scope.incident.category?void $http.post("/calendar/update",$scope.incident).success(function(){$scope.navMonth($scope.incident.start),$scope.incident={},$scope.eventPage(0),$(".fc-day").removeClass("start end range"),$(".calendar-view").fullCalendar("refetchEvents")}):alert("Please assign a category")},$scope.removeEvent=function(){1==confirm("Are you sure you want to remove this event?")&&$http.post("/calendar/remove",{remove:$scope.incident._id,start:moment($scope.incident.start,"DD/MM/YYYY").format(),title:$scope.incident.title}).success(function(){$scope.incident={},$scope.eventPage(0),$(".fc-day").removeClass("start end range"),$(".calendar-view").fullCalendar("refetchEvents")})},$scope.upcomingEvents=[],$scope.getUpcoming=function(){$http.post("/calendar/upcoming",{categories:$scope.eventFilter}).success(function(upcomingData){$scope.upcomingEvents=upcomingData;var today=moment(),tomorrow=moment().add("1","day");for(i in $scope.upcomingEvents)if(moment($scope.upcomingEvents[i].start).isBefore(today,"day")?$scope.upcomingEvents[i].timeline="history":moment($scope.upcomingEvents[i].start).isSame(today,"day")?$scope.upcomingEvents[i].timeline="today":moment($scope.upcomingEvents[i].start).isSame(tomorrow,"day")?$scope.upcomingEvents[i].timeline="tomorrow":moment($scope.upcomingEvents[i].start).isAfter(today,"day")&&($scope.upcomingEvents[i].timeline="future"),$scope.upcomingEvents[i].period=moment($scope.upcomingEvents[i].start).format("DD/MM"),$scope.upcomingEvents[i].end){var start=moment($scope.upcomingEvents[i].start).format("DD/MM"),end=moment($scope.upcomingEvents[i].end).format("DD/MM");$scope.upcomingEvents[i].period=start+" - "+end}})},$scope.getUpcoming(),$scope.upcomingClick=function(stuff){$scope.navMonth(stuff.start),$scope.eventPage(2),$scope.getEvent(stuff)},$cookies.eventFilter||($cookies.eventFilter=[]),$scope.eventFilter="string"==typeof $cookies.eventFilter?$cookies.eventFilter.split(","):$cookies.eventFilter,$scope.categoryToggle=function(id){if($scope.eventFilter.indexOf(id)>-1){var index=$scope.eventFilter.indexOf(id);$scope.eventFilter.splice(index,1)}else-1==$scope.eventFilter.indexOf(id)&&$scope.eventFilter.push(id);$cookies.eventFilter=$scope.eventFilter},$scope.$watch("eventFilter",function(){$(".calendar-view").fullCalendar("refetchEvents"),$scope.incidentCancel()},!0),$scope.removeEventCategories=function(){$scope.eventFilter.length=0,$(".checkboxes input").attr("checked",!1)}}]);var ctrl=angular.module("projects",[]);ctrl.controller("projectsController",["$scope","$rootScope","$http","$cookies","$timeout",function($scope,$rootScope,$http,$cookies,$timeout){$rootScope.slug="projects",$rootScope.heading="Projects",$rootScope.moniker=$rootScope.heading+$rootScope.seperator+$rootScope.masthead,$scope.projectViews=[{name:"list",url:"/partials/projects/list"},{name:"calendar",url:"/partials/projects/calendar"}],$cookies.projectView||($cookies.projectView=0),$scope.projectView=$scope.projectViews[$cookies.projectView],$scope.setProjectView=function(view){$cookies.projectView=view,$scope.projectView=$scope.projectViews[$cookies.projectView]},$cookies.statusProjects||($cookies.statusProjects="all"),$scope.statusProjects=$cookies.statusProjects,$scope.setStatusProjects=function(status){$scope.statusProjects!=status&&($cookies.statusProjects=status),$scope.statusProjects==status&&($cookies.statusProjects="all"),$scope.statusProjects=$cookies.statusProjects,$scope.projectsPage=0,$scope.projectsCriteria.page=$scope.projectsPage,$scope.projectsCriteria.completed=$scope.statusProjects,"list"==$scope.projectView.name&&$scope.getProjects(),"calendar"==$scope.projectView.name&&$(".projects-calendar-view").fullCalendar("refetchEvents")},$cookies.sortProjects||($cookies.sortProjects="-postDate"),$scope.sortProjects=$cookies.sortProjects,$scope.setSortProjects=function(){$cookies.sortProjects=$scope.sortProjects,$scope.projectsCriteria.sort=$scope.sortProjects,$scope.getProjects()},$cookies.categoriesProjects||($cookies.categoriesProjects=[]),$scope.categoriesProjects="string"==typeof $cookies.categoriesProjects?$cookies.categoriesProjects.split(","):$cookies.categoriesProjects,$scope.categoryToggle=function(id){if($scope.categoriesProjects.indexOf(id)>-1){var index=$scope.categoriesProjects.indexOf(id);$scope.categoriesProjects.splice(index,1)}else-1==$scope.categoriesProjects.indexOf(id)&&$scope.categoriesProjects.push(id);$scope.projectsPage=0,$scope.projectsCriteria.page=$scope.projectsPage,$scope.projectsCriteria.categories=$scope.categoriesProjects,"list"==$scope.projectView.name&&$scope.getProjects(),"calendar"==$scope.projectView.name&&$(".projects-calendar-view").fullCalendar("refetchEvents"),$cookies.categoriesProjects=$scope.categoriesProjects},$scope.clearProjectSearch=function(){delete $scope.projectSearch,delete $scope.projectsCriteria.search,$scope.getProjects()},$scope.navProjects=function(direction){"next"==direction&&($scope.projectsPage=$scope.projectsPage+1),"prev"==direction&&($scope.projectsPage=$scope.projectsPage-1),$scope.projectsCriteria.page=$scope.projectsPage,$scope.getProjects()},$scope.projectsPage=0,$scope.projectsLimit=8,$scope.projectsPages=1,$scope.projectsCriteria={limit:$scope.projectsLimit,page:$scope.projectsPage,sort:$scope.sortProjects,completed:$scope.statusProjects,categories:$scope.categoriesProjects},$scope.getProjects=function(){$scope.projectList=[],$http.post("/projects/list",$scope.projectsCriteria).success(function(projectResults){$scope.projectList=projectResults.data;for(i in $scope.projectList){$scope.projectList[i].time=moment($scope.projectList[i].start).isAfter()?"Project starts "+moment($scope.projectList[i].start).fromNow():moment($scope.projectList[i].start).isBefore()&&moment($scope.projectList[i].end).isAfter()?"Project ends "+moment($scope.projectList[i].end).fromNow():moment($scope.projectList[i].end).isBefore()?"Project ended "+moment($scope.projectList[i].end).fromNow():"End date undefined",$scope.projectList[i].description.length>750&&($scope.projectList[i].description=$scope.projectList[i].description.substring(0,749)+"..."),$scope.projectList[i].completedTasks=0;for(j in $scope.projectList[i].tasks)1==$scope.projectList[i].tasks[j].completed&&($scope.projectList[i].completedTasks=$scope.projectList[i].completedTasks+1)}$scope.projectsPages=Math.ceil(projectResults.count/$scope.projectsLimit)})},$scope.getProjects();var timer=!1;$scope.$watch("projectSearch",function(){$scope.projectSearch&&(timer&&$timeout.cancel(timer),timer=$timeout(function(){$scope.projectsCriteria.search=$scope.projectSearch,$scope.getProjects()},500))}),$scope.projectsCalendar=function(){setTimeout(function(){$(".projects-calendar-view").fullCalendar({firstDay:1,eventSources:[{url:"/projects/calendar",method:"POST",data:{completed:$scope.statusProjects,categories:$scope.categoriesProjects},error:function(){alert("there was an error while fetching events!")}}],eventRender:function(event,element){if(element.addClass(event._id),element.attr("title",event.title),element.css({"background-color":event.categories[0].color}),event.categories.length>1)for(i in event.categories)element.append('<span class="cat-'+i+'" style="background-color: '+event.categories[i].color+'"></span>')},eventMouseover:function(event){var scope=angular.element("#main").scope(),rootScope=scope.$root,hoverColor=rootScope.morphColor(event.categories[0].color,40);$("."+event._id).css("background-color",hoverColor)},eventMouseout:function(event){$("."+event._id).css("background-color",event.categories[0].color)},eventClick:function(event){window.location.pathname="/#/projects/"+event.slug}})},1)},$scope.projCalDate=moment(),$scope.projCalActual=moment().format("MMMM YYYY"),$scope.projCalMonth=moment($scope.projCalDate).format("MMMM YYYY"),$scope.navMonth=function(arg){var gotoMonth=moment();"next"==arg?gotoMonth=moment($scope.projCalDate).add("1","month"):"prev"==arg?gotoMonth=moment($scope.projCalDate).subtract("1","month"):moment(arg).isValid&&(gotoMonth=arg),$scope.projCalDate=moment(gotoMonth),$scope.projCalMonth=moment(gotoMonth).format("MMMM YYYY"),$(".projects-calendar-view").fullCalendar("gotoDate",gotoMonth)}}]),ctrl.controller("projectsForm",["$scope","$rootScope","$http","$routeParams",function($scope,$rootScope,$http,$routeParams){$rootScope.slug="projects",$rootScope.heading="Create project",$routeParams.slug&&($rootScope.heading="Update project"),$rootScope.moniker=$rootScope.heading+$rootScope.seperator+$rootScope.masthead,$scope.userList=[],$http.post("/users/list").success(function(userData){$scope.userList=userData}),$scope.initProject=function(){$scope.venture={categories:[],participants:[],tasks:[]}},$scope.initProject(),$routeParams.slug&&$http.post("/projects/detail",{slug:$routeParams.slug}).success(function(projectData){$scope.venture=projectData,$scope.venture.start&&($scope.venture.start=moment($scope.venture.start).format("DD/MM/YYYY")),$scope.venture.end&&($scope.venture.end=moment($scope.venture.end).format("DD/MM/YYYY")),angular.forEach($scope.venture.tasks,function(task){task.start&&(task.start=$rootScope.displayDate(task.start)),task.end&&(task.end=$rootScope.displayDate(task.end)),$http.post("/marked",{text:task.description}).success(function(markedText){task.markedDescription=markedText})});for(i in $scope.venture.categories)$scope.venture.categories[i]=$scope.venture.categories[i]._id}),$scope.addParticipant=function(person){$scope.userSearch="",0==$scope.venture.participants.length&&($scope.venture.owner=person._id),$scope.venture.participants.push(person)},$scope.addParticipantKeydown=function($event,index,person){13==$event.keyCode&&($scope.userSearch="",0==$scope.venture.participants.length&&($scope.venture.owner=person._id),$scope.venture.participants.push(person))},$scope.removeParticipant=function(index){$scope.venture.participants[index]._id==$scope.venture.owner?($scope.venture.participants.splice(index,1),$scope.venture.owner=0==$scope.venture.participants.length?"":$scope.venture.participants[0]._id):$scope.venture.participants.splice(index,1)},$scope.categoryToggle=function(id){if($scope.venture.categories.indexOf(id)>-1){var index=$scope.venture.categories.indexOf(id);$scope.venture.categories.splice(index,1)}else-1==$scope.venture.categories.indexOf(id)&&$scope.venture.categories.push(id)},$("#new-task-start").datepicker({dateFormat:"dd/mm/yy",beforeShow:function(){$("#ui-datepicker-div").addClass("right")},onClose:function(selectedDate){$("#new-task-end").datepicker("option","minDate",selectedDate)}}),$("#new-task-end").datepicker({dateFormat:"dd/mm/yy",beforeShow:function(){$("#ui-datepicker-div").addClass("right")},onClose:function(selectedDate){$("#new-task-start").datepicker("option","maxDate",selectedDate)}}),$scope.checkDates=function(){$scope.venture.start="",$scope.venture.end="";for(i in $scope.venture.tasks){$scope.venture.start||($scope.venture.start=$scope.venture.tasks[i].start),$scope.venture.end||($scope.venture.end=$scope.venture.tasks[i].end);var projectStart=moment($scope.venture.start,"DD/MM/YYYY"),projectEnd=moment($scope.venture.end,"DD/MM/YYYY"),taskStart=moment($scope.venture.tasks[i].start,"DD/MM/YYYY"),taskEnd=moment($scope.venture.tasks[i].end,"DD/MM/YYYY");moment(projectStart).isAfter(taskStart)&&($scope.venture.start=$scope.venture.tasks[i].start),moment(projectEnd).isBefore(taskEnd)&&($scope.venture.end=$scope.venture.tasks[i].end),console.log($scope.venture.tasks[i].start+"---"+$scope.venture.tasks[i].end+"- - - - -"+$scope.venture.start+"---"+$scope.venture.end)}},$scope.initTask=function(){$scope.newTask={priority:2,participants:[],start:"",end:"",author:"",postDate:""},$scope.updatingTask="none"},$scope.initTask(),$scope.copyTask={},$scope.updateTask=function(task,index){$scope.copyTask=task,$scope.updatingTask=index},$scope.cancelUpdateTask=function(){$scope.initTask(),$scope.copyTask={}},$scope.confirmUpdateTask=function(task){$scope.venture.tasks[$scope.venture.tasks.indexOf(task)]=$scope.copyTask,$scope.initTask(),$scope.copyTask={},$scope.checkDates()},$scope.removeTask=function(task){1==confirm("Are you sure you want to remove this task?")&&($scope.venture.tasks.splice($scope.venture.tasks.indexOf(task),1),$scope.initTask(),$scope.copyTask={},$scope.checkDates())},$scope.addTaskParticipant=function(person){$scope.humanSearch="",0==$scope.newTask.participants.length&&($scope.newTask.owner=person._id),$scope.newTask.participants.push(person)},$scope.addTaskParticipantKeydown=function($event,person){13==$event.keyCode&&($scope.humanSearch="",0==$scope.newTask.participants.length&&($scope.newTask.owner=person._id),$scope.newTask.participants.push(person))},$scope.removeTaskParticipant=function(id,index){for(i in $scope.venture.tasks)$scope.venture.tasks[i]._id==id&&($scope.venture.tasks[i].participants[index]._id==$scope.venture.tasks[i].owner?($scope.venture.tasks[i].participants.splice(index,1),$scope.venture.tasks[i].owner=0==$scope.venture.tasks[i].participants.length?"":$scope.venture.tasks[i].participants[0]._id):$scope.venture.tasks[i].participants.splice(index,1))},$scope.removeNewTaskParticipant=function(index){$scope.newTask.participants[index]._id==$scope.newTask.owner?($scope.newTask.participants.splice(index,1),$scope.newTask.owner=0==$scope.newTask.participants.length?"":$scope.newTask.participants[0]._id):$scope.newTask.participants.splice(index,1)};var uncategorized="";for(i in $rootScope.categoryList)"uncategorized"==$rootScope.categoryList[i].slug&&(uncategorized=$rootScope.categoryList[i]._id);$scope.completeTask=function(task){$scope.venture.tasks[$scope.venture.tasks.indexOf(task)].completed=!0},$scope.uncompleteTask=function(task){$scope.venture.tasks[$scope.venture.tasks.indexOf(task)].completed=!1},$scope.addNewTask=function(){return $scope.newTask.title?$scope.newTask.description?$scope.newTask.start?$scope.newTask.end?void $http.post("/marked",{text:$scope.newTask.description}).success(function(markedText){$scope.newTask.markedDescription=markedText,$scope.newTask.author=$scope.user._id,$scope.newTask.postDate=moment().format(),$scope.venture.tasks.push($scope.newTask),$scope.initTask(),$scope.checkDates()}):alert("Please give your task an end date"):alert("Please give your task a start date"):alert("Please give your task a description"):alert("Please give your task a title")},$scope.removeProject=function(){1==confirm("Are you sure you want to remove this project?")&&$http.post("/projects/remove",{remove:$scope.venture._id,slug:$scope.venture.slug,title:$scope.venture.title}).success(function(){window.location.pathname="/#/projects"})},$scope.createProject=function(){return $scope.venture.slug=$rootScope.slugify($scope.venture.title),$scope.venture.postDate=moment(),$scope.venture.author=$rootScope.user._id,$scope.venture.categories.length<1&&$scope.venture.categories.push(uncategorized),$scope.venture.tasks<1?alert("Please add at least one task"):void $http.post("/projects/create",$scope.venture).success(function(){window.location.pathname="/#/projects/"+$scope.venture.slug})},$scope.updateProject=function(){$scope.venture.author=$scope.venture.author._id,$scope.venture.slug=$rootScope.slugify($scope.venture.title),$scope.venture.editDate=moment(),$scope.venture.editor=$rootScope.user._id,$scope.venture.categories.length<1&&$scope.venture.categories.push(uncategorized),$http.post("/projects/update",$scope.venture).success(function(){window.location.pathname="/#/projects/"+$scope.venture.slug})}}]),ctrl.controller("projectsDetail",["$scope","$rootScope","$routeParams","$http","$cookies",function($scope,$rootScope,$routeParams,$http,$cookies){$rootScope.slug="projects",$rootScope.heading="Project detail",$rootScope.moniker=$rootScope.heading+$rootScope.seperator+$rootScope.masthead,$scope.projectDetails=[{name:"description",url:"/partials/projects/description"},{name:"timeline",url:"/partials/projects/timeline"}],$cookies.projectDetail||($cookies.projectDetail=0),$scope.projectDetail=$scope.projectDetails[$cookies.projectDetail],$scope.setProjectDetail=function(detail){$cookies.projectDetail=detail,$scope.projectDetail=$scope.projectDetails[$cookies.projectDetail]},$scope.getProject=function(){$scope.currentProject={},$http.post("/projects/detail",{slug:$routeParams.slug}).success(function(projectData){if($scope.currentProject=projectData,$rootScope.heading=$scope.currentProject.title+" « Projects",$rootScope.moniker=$rootScope.heading+$rootScope.seperator+$rootScope.masthead,$scope.currentProject.markedDescription="",$http.post("/marked",{text:$scope.currentProject.description}).success(function(markedText){$scope.currentProject.markedDescription=markedText}),$scope.currentProject.duration="Undefined",$scope.currentProject.start&&$scope.currentProject.end){var start=moment($scope.currentProject.start),end=moment($scope.currentProject.end);for($scope.currentProject.duration=end.from(start,!0),$scope.currentProject.daysCount=start.diff(end,"days"),$scope.currentProject.today=moment().format(),$scope.currentProject.days=[],day=0;day>=$scope.currentProject.daysCount;day--){var time={tasks:0,date:moment(start).subtract(day,"day")};$scope.currentProject.days.push(time)}}$scope.currentProject.tasks.sort(function(a,b){return new Date(a.start)-new Date(b.start)}),$scope.currentProject.completedTasks=0,angular.forEach($scope.currentProject.tasks,function(task){1==task.completed&&($scope.currentProject.completedTasks=$scope.currentProject.completedTasks+1),task.start&&(task.start=$rootScope.displayDate(task.start)),task.end&&(task.end=$rootScope.displayDate(task.end)),$http.post("/marked",{text:task.description}).success(function(markedText){task.markedDescription=markedText})}),$scope.updatingTask="none",$scope.userList=[],$http.post("/users/list").success(function(userData){$scope.userList=userData})})},$scope.getProject(),$scope.checkDates=function(){$scope.currentProject.start="",$scope.currentProject.end="";for(i in $scope.currentProject.tasks){$scope.currentProject.start||($scope.currentProject.start=$scope.currentProject.tasks[i].start),$scope.currentProject.end||($scope.currentProject.end=$scope.currentProject.tasks[i].end);var projectStart=moment($scope.currentProject.start,"DD/MM/YYYY"),projectEnd=moment($scope.currentProject.end,"DD/MM/YYYY"),taskStart=moment($scope.currentProject.tasks[i].start,"DD/MM/YYYY"),taskEnd=moment($scope.currentProject.tasks[i].end,"DD/MM/YYYY");moment(projectStart).isAfter(taskStart)&&($scope.currentProject.start=$scope.currentProject.tasks[i].start),moment(projectEnd).isBefore(taskEnd)&&($scope.currentProject.end=$scope.currentProject.tasks[i].end)}},$scope.sendProject={},$scope.updateProject=function(){$scope.currentProject.start="",$scope.currentProject.end="";var i=0;angular.forEach($scope.currentProject.tasks,function(task){$http.post("/marked",{text:task.description}).success(function(markedText){task.markedDescription=markedText});var projectStart=moment($scope.currentProject.start,"DD/MM/YYYY"),projectEnd=moment($scope.currentProject.end,"DD/MM/YYYY"),taskStart=moment(task.start,"DD/MM/YYYY"),taskEnd=moment(task.end,"DD/MM/YYYY");$scope.currentProject.start||($scope.currentProject.start=taskStart),$scope.currentProject.end||($scope.currentProject.end=taskEnd),moment(projectStart).isAfter(taskStart)&&($scope.currentProject.start=taskStart),moment(projectEnd).isBefore(taskEnd)&&($scope.currentProject.end=taskEnd),i+=1,i==$scope.currentProject.tasks.length&&($scope.sendProject=angular.copy($scope.currentProject),$scope.sendProject.author=$scope.sendProject.author._id,$scope.sendProject.editDate=moment(),$scope.sendProject.editor=$rootScope.user._id,$scope.sendProject.start=moment($scope.sendProject.start).format("DD/MM/YYYY"),$scope.sendProject.end=moment($scope.sendProject.end).format("DD/MM/YYYY"),delete $scope.sendProject.markedDescription,delete $scope.sendProject.completedTasks,$http.post("/projects/update",$scope.sendProject).success(function(){$scope.sendProject={}}))}),$scope.updatingTask="none",$scope.initComment()},$cookies.sortTasks||($cookies.sortTasks="priority"),$scope.sortTasks=$cookies.sortTasks,$scope.setSortTasks=function(){$cookies.sortTasks=this.sortTasks},$scope.completeTask=function(id){for(i in $scope.currentProject.tasks)$scope.currentProject.tasks[i]._id==id&&($scope.currentProject.tasks[i].completed=!0,$scope.currentProject.completedTasks=$scope.currentProject.completedTasks+1,$scope.currentProject.tasks[i].editor=$scope.user._id,$scope.currentProject.tasks[i].editDate=moment().format()),i==$scope.currentProject.tasks.length-1&&$scope.updateProject()},$scope.uncompleteTask=function(id){for(i in $scope.currentProject.tasks)$scope.currentProject.tasks[i]._id==id&&($scope.currentProject.tasks[i].completed=!1,$scope.currentProject.completedTasks=$scope.currentProject.completedTasks-1,$scope.currentProject.tasks[i].editor=$scope.user._id,$scope.currentProject.tasks[i].editDate=moment().format()),i==$scope.currentProject.tasks.length-1&&$scope.updateProject()
},$scope.copyTask={},$scope.updateTask=function(index){$scope.copyTask=angular.copy($scope.currentProject.tasks[index]),$scope.updatingTask=index},$scope.cancelUpdateTask=function(index){$scope.currentProject.tasks[index]=$scope.copyTask,$scope.copyTask={},$scope.updatingTask="none"},$scope.addTaskParticipant=function(id,person){for(i in $scope.currentProject.tasks)$scope.currentProject.tasks[i]._id==id&&($scope.humanSearch="",0==$scope.currentProject.tasks[i].participants.length&&($scope.currentProject.tasks[i].owner=person._id),$scope.currentProject.tasks[i].participants.push(person))},$scope.addTaskParticipantKeydown=function(id,$event,person){if(13==$event.keyCode)for(i in $scope.currentProject.tasks)$scope.currentProject.tasks[i]._id==id&&($scope.humanSearch="",0==$scope.currentProject.tasks[i].participants.length&&($scope.currentProject.tasks[i].owner=person._id),$scope.currentProject.tasks[i].participants.push(person))},$scope.removeTaskParticipant=function(id,index){for(i in $scope.currentProject.tasks)$scope.currentProject.tasks[i]._id==id&&($scope.currentProject.tasks[i].participants[index]._id==$scope.currentProject.tasks[i].owner?($scope.currentProject.tasks[i].participants.splice(index,1),$scope.currentProject.tasks[i].owner=0==$scope.currentProject.tasks[i].participants.length?"":$scope.currentProject.tasks[i].participants[0]._id):$scope.currentProject.tasks[i].participants.splice(index,1))},$scope.removeTask=function(task){1==confirm("Are you sure you want to remove this task?")&&(1==$scope.currentProject.tasks[$scope.currentProject.tasks.indexOf(task)].completed&&($scope.currentProject.completedTasks=$scope.currentProject.completedTasks-1),$scope.currentProject.tasks.splice($scope.currentProject.tasks.indexOf(task),1),$scope.updateProject(),$scope.copyTask={},$scope.updatingTask="none")},$scope.timelineTask=function(day,index){var time=moment(day),start=moment($scope.currentProject.tasks[index].start,"DD/MM/YYYY"),end=moment($scope.currentProject.tasks[index].end,"DD/MM/YYYY");return moment(start).isSame(time,"day")||moment(end).isSame(time,"day")||moment(time).isAfter(start,"day")&&moment(time).isBefore(end,"day")?!0:void 0},$scope.timelineDetail="none",$scope.timelineView=function(index){$scope.timelineDetail=index,$scope.displayTask=$scope.currentProject.tasks[index]},$scope.updateTimelineTask="none",$scope.updatingTimelineTask=function(index){$scope.updateTimelineTask=index},$scope.initComment=function(){$scope.taskSpeak={body:""},$scope.currentComment="none"},$scope.initComment(),$scope.commentTask=function(index){$scope.currentComment=index},$scope.submitComment=function(task){var index=$scope.currentProject.tasks.indexOf(task);$scope.taskSpeak.postDate=moment().format(),$scope.taskSpeak.author=$rootScope.user,$scope.currentProject.tasks[index].comments.push($scope.taskSpeak),$scope.updateProject()},$scope.removeComment=function(task,comment){var x=$scope.currentProject.tasks.indexOf(task),y=$scope.currentProject.tasks[x].comments.indexOf(comment);$scope.currentProject.tasks[x].comments.splice(y,1),$scope.updateProject()}}]);var ctrl=angular.module("contacts",[]);ctrl.controller("contactsController",["$scope","$rootScope","$routeParams","$http","$filter",function($scope,$rootScope){$rootScope.slug="contacts",$rootScope.heading="Contacts",$rootScope.moniker=$rootScope.heading+$rootScope.seperator+$rootScope.masthead}]);var ctrl=angular.module("settings",[]);ctrl.controller("settingsController",["$scope","$rootScope","$routeParams","$http","$filter",function($scope,$rootScope,$routeParams){if($rootScope.slug="settings",$scope.settings=[{name:"Profile",slug:"profile",url:"/partials/settings/profile"},{name:"Users",slug:"users",url:"/partials/settings/users"},{name:"Structure",slug:"structure",url:"/partials/settings/structure"},{name:"Categories",slug:"categories",url:"/partials/settings/categories"}],$routeParams.option){$scope.currentSetting=$routeParams.option;for(i in $scope.settings)$scope.settings[i].slug==$routeParams.option&&($scope.currentURL=$scope.settings[i].url,$rootScope.heading=$scope.settings[i].name+" « Settings")}else $scope.currentSetting=$scope.settings[0].slug,$scope.currentURL=$scope.settings[0].url,$rootScope.heading=$scope.settings[0].name+" « Settings";$rootScope.moniker=$rootScope.heading+$rootScope.seperator+$rootScope.masthead}]),ctrl.controller("settingsCategories",["$scope","$rootScope","$routeParams","$http","$filter",function($scope,$rootScope,$routeParams,$http){$scope.newCategory={},$scope.createCategory=function(){$scope.newCategory.name?$scope.newCategory.color?($scope.newCategory.slug=$rootScope.slugify($scope.newCategory.name),$http.post("/categories/create",$scope.newCategory).success(function(){$http.post("/categories/list").success(function(categoryData){$rootScope.categoryList=categoryData,$scope.newCategory={}})})):alert("Please choose a color"):alert("Please fill out a name")},$scope.updateCategory=function(index){$rootScope.categoryList[index].slug=$rootScope.slugify($rootScope.categoryList[index].name),$http.post("/categories/update",$rootScope.categoryList[ipndex])},$scope.redirectCategory={from:0,to:0},$scope.removeCategory=function(){0==$scope.redirectCategory.to?alert("Please choose redirect category"):$http.post("/categories/remove",$scope.redirectCategory).success(function(){$http.post("/categories/list").success(function(categoryData){$rootScope.categoryList=categoryData,$scope.redirectCategory={from:0,to:0}})})}}]),ctrl.controller("settingsUsers",["$scope","$rootScope","$routeParams","$http","$filter","$upload",function($scope,$rootScope,$routeParams,$http,$filter,$upload){$scope.userView="create",$scope.userList=[],$http.post("/users/list").success(function(userData){$scope.userList=userData,$scope.userLimit=8,$scope.userOffset=0,$scope.userPages=Math.ceil($scope.userList.length/$scope.userLimit)}),$scope.newUser={role:"user",department:"management",active:!0},$scope.passwordMatch=!0,$scope.passwordCheck=function(){"create"==$scope.userView?$scope.newUser.password!=$scope.newUser.confirm?$scope.passwordMatch=!1:$scope.newUser.password==$scope.newUser.confirm&&($scope.passwordMatch=!0):"update"==$scope.userView&&($scope.editUser.password!=$scope.editUser.confirm?$scope.passwordMatch=!1:$scope.editUser.password==$scope.editUser.confirm&&($scope.passwordMatch=!0))},$scope.selectFile=function($files){$scope.files=$files,console.log($files[0])},$scope.createUser=function(){if($scope.newUser.password!=$scope.newUser.confirm)alert("Your passwords do not match, please retry");else{var username=$scope.newUser.name.first+" "+$scope.newUser.name.last;$scope.newUser.username=$rootScope.slugify(username),$scope.newUser.birthday&&($scope.newUser.birthday=moment($scope.newUser.birthday,"DD-MM-YYYY").format()),$scope.newUser.postDate=moment().format(),$http.post("/users/create",$scope.newUser).success(function(data){if($scope.files){var picture=$scope.files[0];$scope.upload=$upload.upload({url:"/users/avatar",data:{_id:data._id},file:picture}).success(function(){window.location.reload()})}else window.location.reload()})}},$scope.userEditor=function(id){"create"==$scope.userView?($scope.userView="update",$http.post("/users/detail",{_id:id}).success(function(userData){$scope.editUser=userData,$scope.editUser.birthday=moment($scope.editUser.birthday).format("DD-MM-YYYY")})):"update"==$scope.userView&&id!=$scope.editUser._id?$http.post("/users/detail",{_id:id}).success(function(userData){$scope.editUser=userData,$scope.editUser.birthday=moment($scope.editUser.birthday).format("DD-MM-YYYY")}):($scope.userView="create",$scope.editUser={})},$scope.updateUser=function(){if($scope.editUser.password!=$scope.editUser.confirm)alert("Your passwords do not match, please retry");else{var username=$scope.editUser.name.first+" "+$scope.editUser.name.last;$scope.editUser.username=$rootScope.slugify(username),$scope.editUser.birthday&&($scope.editUser.birthday=moment($scope.editUser.birthday,"DD-MM-YYYY").format()),$scope.editUser.editDate=moment().format(),$http.post("/users/update",$scope.editUser).success(function(data){if($scope.files){var picture=$scope.files[0];$scope.upload=$upload.upload({url:"/users/avatar",data:{_id:data._id},file:picture}).success(function(){window.location.reload()})}else window.location.reload()})}},$scope.removeUser=function(){1==confirm("Are you sure you want to remove this user?")&&$http.post("/users/remove",{remove:$scope.editUser._id}).success(function(){window.location.reload()})},$scope.closeUpdateUser=function(){$scope.userView="create",$scope.editUser={}}}]),ctrl.controller("settingsProfile",["$scope","$rootScope","$routeParams","$http","$filter","$upload",function($scope,$rootScope,$routeParams,$http,$filter,$upload){$http.post("/users/detail",{_id:$rootScope.user._id}).success(function(data){$scope.human=data,$scope.human.birthday=moment($scope.human.birthday).format("DD-MM-YYYY")}),$scope.passwordMatch=!0,$scope.passwordCheck=function(){"create"==$scope.userView?$scope.newUser.password!=$scope.newUser.confirm?$scope.passwordMatch=!1:$scope.newUser.password==$scope.newUser.confirm&&($scope.passwordMatch=!0):"update"==$scope.userView&&($scope.editUser.password!=$scope.editUser.confirm?$scope.passwordMatch=!1:$scope.editUser.password==$scope.editUser.confirm&&($scope.passwordMatch=!0))},$scope.updateProfile=function(){if($scope.human.password!=$scope.human.confirm)alert("Your passwords do not match, please retry");else{var username=$scope.human.name.first+" "+$scope.human.name.last;$scope.human.username=$rootScope.slugify(username),$scope.human.birthday&&($scope.human.birthday=moment($scope.human.birthday,"DD-MM-YYYY").format()),$scope.human.editDate=moment().format(),$http.post("/users/update",$scope.human).success(function(data){if($scope.files){var picture=$scope.files[0];$scope.upload=$upload.upload({url:"/users/avatar",data:{_id:data._id},file:picture}).success(function(){window.location.reload()})}else window.location.reload()})}}}]);